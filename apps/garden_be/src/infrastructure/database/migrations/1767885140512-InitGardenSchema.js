 ...
 */
module.exports = class InitGardenSchema1767885140512 {
    name = 'InitGardenSchema1767885140512'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."growthConditions_soiltype_enum" AS ENUM('sandy', 'loamy', 'clay', 'other')`);
        await queryRunner.query(`CREATE TABLE "growthConditions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "minTemperature" double precision NOT NULL, "maxTemperature" double precision NOT NULL, "minHumidity" double precision NOT NULL, "maxHumidity" double precision NOT NULL, "soilType" "public"."growthConditions_soiltype_enum" NOT NULL DEFAULT 'loamy', "herb_id" uuid, CONSTRAINT "PK_53279f3ba877ecea94ed1bd542c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "plant" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "plant" ADD "name" character varying(256) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "growthConditions" ADD CONSTRAINT "FK_0562947a1764124d85da10588b4" FOREIGN KEY ("herb_id") REFERENCES "herb"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "growthConditions" DROP CONSTRAINT "FK_0562947a1764124d85da10588b4"`);
        await queryRunner.query(`ALTER TABLE "history" DROP CONSTRAINT "FK_c9d3f3c5dcf0b2e18d2f5f1997a"`);
        await queryRunner.query(`ALTER TABLE "plant" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "plant" ADD "name" character varying(100) NOT NULL`);
        ...
        await queryRunner.query(`DROP TABLE "growthConditions"`);
        await queryRunner.query(`DROP TYPE "public"."growthConditions_soiltype_enum"`);
